function plot_automatic_artifacts(data_with_artifacts, artifact_samples, subject_id, max_segments, fontSize)
    ...
    %
    % Usage: plot_automatic_artifacts(EEG_data, artifact_samples, '011201', 5, 14)
